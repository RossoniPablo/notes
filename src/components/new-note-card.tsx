...
interface NewNorteCardProps {
    onNoteCreated: (content: string) => void
}

let speechRecognition: SpeechRecognition | null = null

export function NewNorteCard({ onNoteCreated }: NewNorteCardProps) {
    ...
    // Previnindoo c coportamento padrão do form, que é encaminhar para outra pagina
    ...
    return (
        <Dialog.Root>
            <Dialog.Trigger className="rounded-md flex flex-col outline-none bg-slate-700 text-left p-5 sgap-3 hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-500">
